...
1、微服务聚合组件Knife4jAggregation强势发布，聚合OpenAPI文档太简单了,[详见文档](middleware-sources/aggregation-introduction)

2、Knife4j独立运行组件Knife4jAggregationDesktop强制发布,渲染OpenAPI规范就用Knife4j,[详见文档](middleware-sources/desktop-introduction)

3、云端服务聚合OpenAPI文档Knife4jCloud组件,使用依然很简单,[详见文档](middleware-sources/cloud-introduction)
...
以下视频为Knife4jAggregationDesktop 1.0发布的使用视频，在发布[Knife4j 4.0](/docs/changelog/x/4.0)版本时，作者重构了该组件，目前没有最新视频，开发者可以参考[使用文档](middleware-sources/desktop-introduction)
:::
