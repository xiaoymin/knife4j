...
Knife4j鼓励开发者通过[获取帮助](community/community-get-helps)中的方式发起提问，这样有助于Knife4j的社区发展,当然如果你嫌麻烦，也可以直接加入Knife4j提供的QQ群或者微信交流群与作者直接交流获取帮助
...
目前QQ群作者极少时间登录,可能回复处理的较慢,建议开发者[提issues](https://gitee.com/xiaoym/knife4j/issues)或者加微信交流群。
