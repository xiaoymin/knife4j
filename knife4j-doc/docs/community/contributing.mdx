...
- 发表你的看法：[Knife4j论坛](https://github.com/xiaoymin/swagger-bootstrap-ui/discussions)
...
- [knife4j-aggregation-desktop](https://gitee.com/xiaoym/knife4j/tree/dev/knife4j-aggregation-desktop):Knife4j的独立中间件，基于Java编写，可以独立运行渲染OpenAPI规范文件
