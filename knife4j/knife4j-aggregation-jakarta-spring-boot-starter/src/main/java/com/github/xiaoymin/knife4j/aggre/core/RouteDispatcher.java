...
public class RouteDispatcher {
    ...
    public static final String OPENAPI3_GROUP_ENDPOINT = "/swagger-config";
     ...
     */
    public OpenAPI3Response getOpenAPI3Response(HttpServletRequest request) {
        ...
        if (routers != null && !routers.isEmpty()) {
            routers.sort(Comparator.comparing(SwaggerRoute::getOrder));
            for (SwaggerRoute router : routers) {
