...
package com.github.xiaoymin.knife4j.aggre.spec.v2;

import com.github.xiaoymin.knife4j.aggre.core.pojo.SwaggerRoute;
import com.github.xiaoymin.knife4j.aggre.spec.AbstractOpenAPIResource;
...
public class OpenAPI2Resource extends AbstractOpenAPIResource {
     ...
     * @since v4.2.0
     */
    public OpenAPI2Resource(SwaggerRoute router) {
        super(router.getOrder(), false);
        this.name = router.getName();
        this.url = router.getLocation();
        this.contextPath = router.getServicePath();
